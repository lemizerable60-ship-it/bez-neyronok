//
// PsychoSuite Application - Main JavaScript File
...
window.addEventListener('load', () => {
    ...
    const SettingsScreen = ({ setScreen, setData }) => {
        ...
        const [currentColor, setCurrentColor] = useState(localStorage.getItem('themeColor') || colors[0].value);
    ...
    const App = () => {
        ...
        return React.createElement('div', { className: "min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200" }, renderScreen());
    };
